...
- Environment-driven setup with `.env` so secrets stay out of source control
...
## Notes
- Pydub exports WAV without extra codecs, but installing `ffmpeg` locally unlocks additional formats if you need them later.
- Keep your `.env` out of commits. `.gitignore` already excludes it. 
